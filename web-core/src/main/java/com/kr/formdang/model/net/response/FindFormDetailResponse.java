...
@AllArgsConstructor
@NoArgsConstructor
public class FindFormDetailResponse extends DefaultResponse {
    ...
    public FindFormDetailResponse(FormTbEntity formTbEntity, List<QuestionTbEntity> questionTbEntities) {
